    ...
    <div class="home">
      <div class="home_head">
        <el-row>
          ...
          <el-col :span="5" style="padding-right: 20px"><el-select v-model="selectStatus" clearable
              placeholder="Select Status" style="width: 100%" @change="change('status', $event)">
              <el-option v-for="item in status" :key="item.value" :label="item.label" :value="item.value" />
            </el-select></el-col>
          <el-col :span="5" style="padding-right: 10px"><el-input :suffix-icon="Search" :model-value="searchIp"
              placeholder="Enter ip to search" clearable @input="change('ip', $event)"
              @keyup.enter="searchIpHandle" /></el-col>
